...
int main(){
    ...
    short overflow_num_1  = 3276666; // 不会报错，但是值会变成 -134
    cout << "overflow_num_1 example: it should be 3276666 but the value in code is : "  << overflow_num_1 << endl; // -32768
    ...
    long long people_on_earth {80'0000'0000}; // 为方便阅读c++ 14标准后支持'数字分割 C++11 不支持该标准
    cout << "people on earth: " << people_on_earth << endl;

    long long wuhu {10'000'000};
    cout << "wuhu area is: "<< wuhu << "km" << endl;
    ...
    double pi {3.1415926}; //打印时只会打印出小数点后5位
    cout << "pi: " << pi << endl;
    ...
    cout << "add to cart: " << add_to_cart << endl; // 打印时 为0 表示false
